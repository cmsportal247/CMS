const API_BASE = 'https://backend-7l9n.onrender.com'; // Update to your API base URL
let token = ''; // This will store the login token
...
// Load cases and display in table
...
// Edit case (populate the modal for editing)
const editCase = (id) => {
...
// Handle form submission (Add/Edit case)
